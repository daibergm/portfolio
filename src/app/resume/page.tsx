'use client';
import { Footer, Header, LineItem, ResumeCard, Tag } from '@/components';
        ...
        <div data-aos="fade">
          <div className="container sm:px-5 md:px-10 lg:px-20 ">
            <div className="py-12 px-4">
              {/*page title here */}
              <h2 className="after-effect after:left-44 mb-[40px] mt-12 lg:mt-0 text-white">
                Resume
              </h2>
          ...
          <div className="container :bg-[#0D0D0D] py-12 px-4 sm:px-5 md:px-10 lg:px-20">
            <div className="grid grid-cols-1  md:grid-cols-2 gap-8">
              <div className="col-span-1">
                <h4 className="text-5xl text-white font-medium mb-6">Working Skills</h4>
              ...
              <div className="col-span-1">
                <h4 className="text-5xl text-white font-medium mb-8">Knowledges</h4>
